...
public class DeletePatientController 
{
	...
	@RequestMapping(value = "/deletePatient.html", method = RequestMethod.POST)
	public ModelAndView delete(@RequestParam("pid")String pid)
	{
		try{
			infoLog.logActivities("in DeletePatient.html-delete: got= "+pid);
			
			int i=dao1.delete(pid);
			infoLog.logActivities("returned to DeletePatient.html-delete: got= "+i);
				...
				if(i==1)
				{
					...
					mv.addObject("patients", dao2.opdQueue());
					return mv;
				}
				else
				{   throw new Exception();  }
			...
			{
				infoLog.logActivities("in DeletePatient.html-delete: "+e);
				ModelAndView mv= new ModelAndView();
