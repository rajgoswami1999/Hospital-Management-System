...
<script>
	...
	<div class="container"><br/>
		...
		<div class="row">
			<div class="col-sm-5">
			<h1><span style="color:grey;">C</span><span style="color:red;">A</span><span style="color:grey;">RE</span> HOSPITAL</h1>
			</div>
			<div class="col-sm-7">
	...
	<div class="demo">
			...
			<table class="table borderless">
				...
				try{
			     ...
			     <tr><td>Medicines and Dosage</td><td><%= prescription.getMedicinesDose() %></td></tr>
							     <tr><td>Do's</td><td><%= prescription.getDos() %></td></tr>
							    <tr><td>Dont's</td><td><%= prescription.getDonts() %></td></tr>
			     <tr>
			...
			<div>
				...
				<hr/>
				Our Centers:<br/>
			    1. Care Hospital, BulandShahr, Ghaziabad , Bareilly , Uttar Pradesh |
			    2. NIIMS Multispeciality Hospital, Buland Shahr, Delhi Road, Uttar Pradesh  <br/>
			    Mobile No. 9997674184 | Phone No. 0253-2575151 | E-mail: drsachinkdeore@gmail.com	
			</div>	
