			...
			<h1>All Patient</h1><br/>
				...
				<thead>
					<tr>
		     		<td>Pid</td>
					<td>Name</td>
					<td align="center">Patient Details</td>
			    ...
			    <tbody>
			       ...
			       <tr>
			        <td><%= pat.getPid() %></td>
			        <td><%= pat.getName().getFirstName() %>&nbsp;<%= pat.getName().getMiddleName() %>&nbsp;<%= pat.getName().getLastName() %></td>	
			      	
			      	<td> 
			      		<form action="viewPatient.html" method="post">
			      			<input type="text" name="pid" value="<%= pat.getPid()%>" hidden="">
