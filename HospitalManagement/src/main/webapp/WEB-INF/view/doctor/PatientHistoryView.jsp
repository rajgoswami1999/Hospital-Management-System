						...
						<table class="table table-bordered">
							<tbody>
							   <%--  <tr>
							     ...
							     <tr><td>Symptoms</td><td><%= data.getSymptoms() %></td></tr>
				    		...
				    		<tbody>
							   <%--  <tr>
								...
								try{
							     ...
							     <tr><td>Medicines and Dosage</td><td><%= data.getMedicinesDose() %></td></tr>
							     <tr><td>Do's</td><td><%= data.getDos() %></td></tr>
							    <tr><td>Dont's</td><td><%= data.getDonts() %></td></tr>
							    <%-- <tr>
								    <td>Do's</td>
								    <td>
								    	 <%
