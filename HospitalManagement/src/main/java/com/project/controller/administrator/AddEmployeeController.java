...
public class AddEmployeeController 
{
	...
	{	
		...
		//{		
			...
			Employee e1= new Employee(new Date(),n1,birthdate,gender,email,mobileNo,adharNo,country,state,city,a1,role,qualification,specialization);
			//Employee e1= new Employee(n1,birthdate,gender,email,mobileNo,adharNo,country,state,city,a1,role,qualification,specialization);
